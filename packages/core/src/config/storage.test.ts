...
describe('Storage – getGlobalSettingsPath', () => {
  it('returns path to ~/.proto/settings.json', () => {
    const expected = path.join(Storage.getGlobalQwenDir(), 'settings.json');
...
describe('Storage – additional helpers', () => {
  ...
  it('getWorkspaceSettingsPath returns project/.proto/settings.json', () => {
    const expected = path.join(projectRoot, '.proto', 'settings.json');
    expect(storage.getWorkspaceSettingsPath()).toBe(expected);
  });

  it('getUserCommandsDir returns ~/.proto/commands', () => {
    const expected = path.join(Storage.getGlobalQwenDir(), 'commands');
    expect(Storage.getUserCommandsDir()).toBe(expected);
  });

  it('getProjectCommandsDir returns project/.proto/commands', () => {
    const expected = path.join(projectRoot, '.proto', 'commands');
    expect(storage.getProjectCommandsDir()).toBe(expected);
  });

  it('getMcpOAuthTokensPath returns ~/.proto/mcp-oauth-tokens.json', () => {
