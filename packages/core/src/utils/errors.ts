 ...
 * (`--max-tool-calls`, and later `--max-wall-time`). Distinct exit code from
 * `FatalTurnLimitedError` (53) so CI / harness scripts can branch on "run
 * exhausted its budget" vs. "run hit the turn cap". Ported from
