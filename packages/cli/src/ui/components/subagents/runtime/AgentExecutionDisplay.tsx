...
export interface AgentExecutionDisplayProps {
  ...
  config: Config;
  /**
   * When true, this instance is the running SubAgent that currently owns the
   * live viewport. The Ctrl+E / Ctrl+F display-mode shortcuts only fire when
   * focused so parallel running subagents don't both reflow on a single press.
   */
  isFocused?: boolean;
}
