    ...
    sidebar: {
      '/tutorials/': [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Build Your First Sub-Agent',
      ...
      '/guides/': [
        { text: 'Guides', items: [{ text: 'Overview', link: '/guides/' }] },
        {
          ...
          collapsed: false,
          items: [
            { text: 'Run the Setup Wizard', link: '/guides/setup-wizard' },
          ],
        },
        {
          ...
          items: [
            {
              text: 'Configure Models & Auth',
              link: '/guides/configure-models',
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Session Notes', link: '/guides/session-notes' },
        ...
        },
        {
          ...
          items: [
            {
              text: 'Run Headless (Non-Interactive)',
              link: '/guides/run-headless',
            },
          ...
          items: [
            { text: 'SDK API', link: '/reference/sdk-api' },
            {
              ...
              items: [
                ...
                {
                  text: 'Multi-File Read',
                  link: '/reference/tools/multi-file',
                },
                { text: 'Shell', link: '/reference/tools/shell' },
                {
                  text: 'Stop Background Shell',
                  link: '/reference/tools/bg-stop',
                },
                { text: 'Task', link: '/reference/tools/task' },
                { text: 'Skill', link: '/reference/tools/skill' },
                { text: 'LSP', link: '/reference/tools/lsp' },
                {
                  text: 'Ask User Question',
                  link: '/reference/tools/ask-user-question',
                },
                { text: 'Cron Scheduling', link: '/reference/tools/cron' },
                { text: 'Repo Map', link: '/reference/tools/repo-map' },
                {
                  text: 'Exit Plan Mode',
                  link: '/reference/tools/exit-plan-mode',
                },
      ...
      '/explanation/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Sub-Agents', link: '/explanation/sub-agents-design' },
            {
              ...
              link: '/explanation/background-agents-design',
            },
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'Approval Modes', link: '/explanation/approval-modes' },
          ],
        },
      ],
      ...
      '/contributing/': [
        {
          ...
          items: [
            ...
            { text: 'Roadmap', link: '/contributing/roadmap' },
            {
              ...
              items: [
                {
                  text: 'SDK Sub-Agent Examples',
                  link: '/contributing/examples/sdk-agents',
                },
                {
                  text: 'SDK Hook Examples',
                  link: '/contributing/examples/sdk-hooks',
                },
                {
                  text: 'SDK Tool Examples',
                  link: '/contributing/examples/sdk-tools',
                },
                {
                  text: 'Proxy Script Example',
                  link: '/contributing/examples/proxy-script',
                },
              ],
            },
          ],
