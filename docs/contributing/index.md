...
Everything you need to work on proto or build on top of it.

- [Contributing Guide](/contributing/overview) — Code of conduct, PR process, and repo norms
- [Development Workflow](/contributing/development) — Local setup, testing, and the monorepo structure
