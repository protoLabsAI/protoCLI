...
- **GitHub Issues** — individual feature requests and bugs: [github.com/protoLabsAI/protoCLI/issues](https://github.com/protoLabsAI/protoCLI/issues)
- **GitHub Discussions** — proposals and community input: [github.com/protoLabsAI/protoCLI/discussions](https://github.com/protoLabsAI/protoCLI/discussions)
- **Milestones** — grouped work items: [github.com/protoLabsAI/protoCLI/milestones](https://github.com/protoLabsAI/protoCLI/milestones)
...
See [Contributing Guide](./overview) for the full contribution process.
