...
Complete, exact reference material. Use this when you know what you're looking for.

- [Settings](/reference/settings) — All configuration keys for `settings.json`
- [Model Providers](/reference/model-providers) — Supported providers and endpoint configuration
- [Authentication](/reference/auth) — API key and OAuth setup
- [Commands](/reference/commands) — All slash commands available in the REPL
